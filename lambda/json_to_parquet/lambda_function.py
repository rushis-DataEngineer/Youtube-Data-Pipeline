...
GLUE_DB = os.environ.get("GLUE_DB_SILVER", "yt-dp-glue-silver")
GLUE_TABLE = os.environ.get("GLUE_TABLE_REFERENCE", "clean-reference-data")
SNS_TOPIC = os.environ.get("SNS_ALERT_TOPIC_ARN", "")
SILVER_PATH = f"s3://{SILVER_BUCKET}/youtube/reference-data/"
